...
function Signup() {
  return (
    <div>
      {/* <!-- component --> */}
      <div className=" flex h-[85vh] items-center justify-center px-5 py-5">
        <div className="bg-gray-100 text-gray-500   rounded-lg w-full overflow-hidden max-w-[1200px] ">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div>
                ...
                <div className="flex  justify-between w-full items-end">
                  <div className="w-full flex gap-4 px-3 mb-5">
                    <button className="block w-full max-w-xs bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold uppercase">
                      REGISTER NOW
                    </button>

                    <Link href={"/"} legacyBehavior >
                      <a className="text-right w-full underline text-red-400 self-center">
